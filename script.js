...
function SnakeGame(canvasWidth, canvasHeight, blockSize, delay)
{
	...
	this.canvas.style.border = "30px solid #000030";
//couleurs de bordure du canvas
	this.canvas.style.margin = "50px auto";
	this.canvas.style.display = "block";
	this.canvas.style.backgroundColor = "#ecf0f1";
	...
	this.gameOver = function()
	{
		...
		this.ctx.strokeText("Game Over", centreX, centreY -40);
		this.ctx.fillText("Game Over", centreX, centreY -40);
		this.ctx.font = "bold 30px sans-serif";
		this.ctx.strokeText("appuyez sur la touche Espace pour rejouer", centreX, centreY +40);
		this.ctx.fillText("appuyez sur la touche Espace pour rejouer", centreX , centreY +40);
		this.ctx.restore();
// couleur et emplacement du game-over
	}
...
//couleur et emplacement des scores
		this.ctx.restore();
	}
